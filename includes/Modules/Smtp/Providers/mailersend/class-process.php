...
class Process extends Abstract_Process {
	...
	public function get_headers() {
		 ...
		 */
		$headers = apply_filters( 'doublescale_smtp_mailersend_mailer_get_headers', $this->headers );
	...
	public function get_body() {
		 ...
		 */
		$body = apply_filters( 'doublescale_smtp_mailersend_mailer_get_body', $this->body );
