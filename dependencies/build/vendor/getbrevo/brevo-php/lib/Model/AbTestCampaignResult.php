...
class AbTestCampaignResult implements ModelInterface, ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['winningVersion' => 'string', 'winningCriteria' => 'string', 'winningSubjectLine' => 'string', 'openRate' => 'string', 'clickRate' => 'string', 'winningVersionRate' => 'string', 'statistics' => 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\AbTestCampaignResultStatistics', 'clickedLinks' => 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\AbTestCampaignResultClickedLinks'];
    /**
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
\class_alias('DoubleScale\\Vendor\\Brevo\\Client\\Model\\AbTestCampaignResult', 'Brevo\\Client\\Model\\AbTestCampaignResult', \false);
