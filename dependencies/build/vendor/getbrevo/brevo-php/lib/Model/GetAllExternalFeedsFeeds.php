...
class GetAllExternalFeedsFeeds implements ModelInterface, ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['id' => 'string', 'name' => 'string', 'url' => 'string', 'authType' => 'string', 'username' => 'string', 'password' => 'string', 'token' => 'string', 'headers' => 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\GetExternalFeedByUUIDHeaders[]', 'maxRetries' => 'int', 'cache' => 'bool', 'createdAt' => '\\DateTime', 'modifiedAt' => '\\DateTime'];
    /**
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
\class_alias('DoubleScale\\Vendor\\Brevo\\Client\\Model\\GetAllExternalFeedsFeeds', 'Brevo\\Client\\Model\\GetAllExternalFeedsFeeds', \false);
