...
class ContactsApi
{
    ...
    {
        $returnType = 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\PostContactInfo';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\PostContactInfo', $e->getResponseHeaders());
    ...
    {
        $returnType = 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\CreateUpdateContactModel';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\CreateUpdateContactModel', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\GetAttributes';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\GetAttributes', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
            throw $e;
    ...
    {
        $returnType = 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\GetExtendedContactDetails';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\GetExtendedContactDetails', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 404:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\GetContactCampaignStats';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\GetContactCampaignStats', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 404:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\GetContacts';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\GetContacts', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\GetFolder';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\GetFolder', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 404:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\GetFolderLists';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\GetFolderLists', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 404:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\GetFolders';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\GetFolders', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\GetExtendedList';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\GetExtendedList', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 404:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\GetLists';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\GetLists', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\GetSegments';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\GetSegments', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\CreatedProcessId';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 202:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\CreatedProcessId', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\ErrorModel', $e->getResponseHeaders());
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
\class_alias('DoubleScale\\Vendor\\Brevo\\Client\\Api\\ContactsApi', 'Brevo\\Client\\Api\\ContactsApi', \false);
