...
import { usePlateEditor, Plate, ParagraphPlugin, PlateLeaf, KEYS } from '@udecode/plate-common/react';
import {
    BoldPlugin,
    ItalicPlugin,
    StrikethroughPlugin,
...
export const useCreateEditor = () => {
    ...
    const { __experimentalInsertBlock } = useDispatch('quillcrm/email-editor');
