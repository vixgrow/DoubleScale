<?php
/**
 * Class Order Billing Address
 *
 * This class is responsible for handling the order billing address merge tag
 *
 * @since 1.0.0
 *
 * @package QuillCRM
...
/**
 * Order Billing Address Merge Tag
 */
class Order_Billing_Address extends Merge_Tag {
	 ...
	 * @var string
	 */
	public $name = 'Order Billing Address';
	 ...
	 * @var string
	 */
	public $description = 'Order Billing Address';
...
Merge_Tags_Manager::instance()->register( new Order_Billing_Address() );
