...
class Process extends Abstract_Process {
	...
	public function set_from( $email, $name ) {
		...
		$this->body['from_email'] = $email;

		if ( ! empty( $name ) ) {
			$this->body['from_name'] = $name;
		}
	}
	...
	public function get_headers() {
		 ...
		 */
		$headers = apply_filters( 'doublescale_smtp_mandrill_mailer_get_headers', $this->headers );
	...
	public function get_body() {
		 ...
		 */
		$body = apply_filters( 'doublescale_smtp_mandrill_mailer_get_body', $this->body );
