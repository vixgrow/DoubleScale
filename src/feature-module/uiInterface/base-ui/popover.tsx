...
const Popovers = () => {
  ...
  const createPopover = (id: any, title: any, content: any, customClass: any) => (
  ...
  const createPopoverLight = (id: any, title: any, content: any, customClass: any) => (
    <Popover id={id} className={customClass}>
      <Popover.Header as="h3">{title}</Popover.Header>
      <Popover.Body>{content}</Popover.Body>
    </Popover>
  ...
  const createPopoverDark = (id: any, title: any, content: any, customClass: any) => (
    <Popover id={id} className={customClass}>
      <Popover.Header as="h3">{title}</Popover.Header>
      <Popover.Body>{content}</Popover.Body>
    </Popover>
  ...
  const createPopoverDismiss = (id: any, title: any, content: any, customClass: any) => (
    <Popover id={id} className={customClass}>
      <Popover.Header as="h3">{title}</Popover.Header>
      <Popover.Body>{content}</Popover.Body>
    </Popover>
  ...
  const createPopoverDisable = (id: any, title: any, customClass: any) => (
    <Popover id={id} className={customClass}>
