 ...
 */
class Cart_Billing_Post_Code extends Merge_Tag {
	...
	public function get_value( $contact, $merge_tag = '' ) {
		...
		$billing_post_code = $abandoned_cart->fields['billing_post_code'] ?? '';

		return $billing_post_code;
	}
}

Merge_Tags_Manager::instance()->register( new Cart_Billing_Post_Code() );
