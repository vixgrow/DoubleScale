...
{
    $form = (string) new \DoubleScale\Vendor\SendGrid\Contacts\RecipientForm($url);
    echo $form . \PHP_EOL;
}
...
function recipientFormSubmit()
{
    ...
    $recipient = new \DoubleScale\Vendor\SendGrid\Contacts\Recipient($firstName, $lastName, $email);
