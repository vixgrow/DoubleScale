 ...
 */
namespace DoubleScale\Vendor\Brevo\Client;
    ...
    public static function deserialize($data, $class, $httpHeaders = null)
    {
        if (null === $data) {
            ...
            if (!empty($discriminator) && isset($data->{$discriminator}) && \is_string($data->{$discriminator})) {
                $subclass = 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\' . $data->{$discriminator};
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
\class_alias('DoubleScale\\Vendor\\Brevo\\Client\\ObjectSerializer', 'Brevo\\Client\\ObjectSerializer', \false);
