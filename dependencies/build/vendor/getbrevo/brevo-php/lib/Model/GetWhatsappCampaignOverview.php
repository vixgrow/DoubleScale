...
class GetWhatsappCampaignOverview implements ModelInterface, ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['id' => 'int', 'campaignName' => 'string', 'campaignStatus' => 'string', 'scheduledAt' => 'string', 'senderNumber' => 'string', 'stats' => 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\WhatsappCampStats', 'template' => 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\WhatsappCampTemplate', 'createdAt' => 'string', 'modifiedAt' => 'string'];
    /**
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
\class_alias('DoubleScale\\Vendor\\Brevo\\Client\\Model\\GetWhatsappCampaignOverview', 'Brevo\\Client\\Model\\GetWhatsappCampaignOverview', \false);
