...
class TasksApi
{
    ...
    {
        $returnType = 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\InlineResponse2012';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\InlineResponse2012', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
            throw $e;
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
\class_alias('DoubleScale\\Vendor\\Brevo\\Client\\Api\\TasksApi', 'Brevo\\Client\\Api\\TasksApi', \false);
