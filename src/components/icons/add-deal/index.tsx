...
const AddDealIcon: React.FC<IconProps> = ({ width = 24, height = 24 }) => {
	return (
		<svg
			width={width}
			height={height}
		...
		>
			...
			<g mask="url(#mask0_31303_43939)">
				<path
					opacity="0.4"
					d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22Z"
					fill="url(#paint0_linear_31303_43939)"
				/>
				<path
					...
					fill="url(#paint1_linear_31303_43939)"
				/>
			</g>
			<defs>
				<linearGradient
					id="paint0_linear_31303_43939"
					x1="2"
					y1="12"
					x2="22"
					y2="12"
