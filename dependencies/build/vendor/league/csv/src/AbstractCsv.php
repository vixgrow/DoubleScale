 ...
 */
abstract class AbstractCsv implements \League\Csv\ByteSequence
{
    ...
    {
        throw \League\Csv\UnavailableStream::dueToForbiddenCloning(static::class);
    }
    /**
    ...
    {
        return new static(new \League\Csv\Stream($stream));
    }
    /**
    ...
    {
        return new static(\League\Csv\Stream::createFromString($content));
    }
    /**
    ...
    {
        return new static(\League\Csv\Stream::createFromPath($path, $open_mode, $context));
    }
    /**
    ...
    public function getInputBOM() : string
    {
        ...
        $this->input_bom = \League\Csv\Info::fetchBOMSequence((string) $this->document->fread(4)) ?? '';
        return $this->input_bom;
    }
    /**
    ...
    {
        return $this->document instanceof \League\Csv\Stream;
    }
    /**
    ...
    {
        return $this->document instanceof \League\Csv\Stream && (static::STREAM_FILTER_MODE & \STREAM_FILTER_READ) === \STREAM_FILTER_READ;
    }
    /**
    ...
    {
        return $this->document instanceof \League\Csv\Stream && (static::STREAM_FILTER_MODE & \STREAM_FILTER_WRITE) === \STREAM_FILTER_WRITE;
    }
    /**
    ...
    {
        if ($length < 1) {
            throw \League\Csv\InvalidArgument::dueToInvalidChunkSize($length, __METHOD__);
        }
    ...
    protected function sendHeaders(string $filename) : void
    {
        if (strlen($filename) != strcspn($filename, '\\/')) {
            throw \League\Csv\InvalidArgument::dueToInvalidHeaderFilename($filename);
        }
    ...
    public function setDelimiter(string $delimiter) : self
    {
        ...
        if (1 !== strlen($delimiter)) {
            throw \League\Csv\InvalidArgument::dueToInvalidDelimiterCharacter($delimiter, __METHOD__);
        }
    ...
    public function setEnclosure(string $enclosure) : self
    {
        ...
        if (1 !== strlen($enclosure)) {
            throw \League\Csv\InvalidArgument::dueToInvalidEnclosureCharacter($enclosure, __METHOD__);
        }
    ...
    public function setEscape(string $escape) : self
    {
        ...
        if ('' !== $escape && 1 !== strlen($escape)) {
            throw \League\Csv\InvalidArgument::dueToInvalidEscapeCharacter($escape, __METHOD__);
        }
        $this->escape = $escape;
        $this->resetProperties();
        return $this;
    ...
    {
        if (!$this->document instanceof \League\Csv\Stream) {
            throw \League\Csv\UnavailableFeature::dueToUnsupportedStreamFilterApi(get_class($this->document));
        }
