...
class GetAttributesAttributes implements ModelInterface, ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['name' => 'string', 'category' => 'string', 'type' => 'string', 'enumeration' => 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\GetAttributesEnumeration[]', 'calculatedValue' => 'string'];
    /**
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
\class_alias('DoubleScale\\Vendor\\Brevo\\Client\\Model\\GetAttributesAttributes', 'Brevo\\Client\\Model\\GetAttributesAttributes', \false);
