...
const GradientAddCallIcon: React.FC<IconProps> = ({
	width = 24,
	height = 24,
}) => {
	return (
		...
		>
			...
			<g mask="url(#mask0_35116_39591)">
				<path
					...
					fill="url(#paint0_linear_35116_39591)"
				/>
				<path
					opacity="0.4"
					...
					fill="url(#paint1_linear_35116_39591)"
				/>
				<path
					...
					fill="url(#paint2_linear_35116_39591)"
				/>
			</g>
			<defs>
				<linearGradient
					id="paint0_linear_35116_39591"
					x1="14.75"
					y1="6"
					x2="21.25"
					y2="6"
...
export default GradientAddCallIcon;
