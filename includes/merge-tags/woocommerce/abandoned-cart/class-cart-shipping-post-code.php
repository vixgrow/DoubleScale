 ...
 */
class Cart_Shipping_Post_Code extends Merge_Tag {
	...
	public function get_value( Automation_Contact_Model $automation_contact, $merge_tag = '' ) {
		...
		$shipping_post_code = $abandoned_cart->fields['shipping_post_code'] ?? '';

		return $shipping_post_code;
	}
}

Merge_Tags_Manager::instance()->register( new Cart_Shipping_Post_Code() );
