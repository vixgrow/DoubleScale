...
class CharsetConverter extends php_user_filter
{
     ...
     */
    public static function addTo(\League\Csv\AbstractCsv $csv, string $input_encoding, string $output_encoding) : \League\Csv\AbstractCsv
    {
        self::register();
    ...
    public function convert(iterable $records) : iterable
    {
        ...
        return new \League\Csv\MapIterator($records, $this);
    }
    /**
