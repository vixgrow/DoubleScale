...
final class SalesNumberingFormatTest extends TestCase {
	...
	public function test_format_sequential_number_uses_six_digit_padding(): void {
		...
		$this->assertSame( 'CON-000003', SalesNumbering::format_sequential_number( 'CON', 3 ) );
	}
	...
	public function test_is_duplicate_number_error_matches_invoice_proposal_and_contract_keys(): void {
		...
		$contract_exception = new QueryException( '', array(), new \Exception( "Duplicate entry 'CON-000001' for key 'contract_number'" ) );
		...
		$this->assertTrue( SalesNumbering::is_duplicate_number_error( $contract_exception ) );
