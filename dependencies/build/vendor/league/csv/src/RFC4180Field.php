...
class RFC4180Field extends php_user_filter
{
     ...
     */
    public static function addTo(\League\Csv\AbstractCsv $csv, string $whitespace_replace = '') : \League\Csv\AbstractCsv
    {
        self::register();
        $params = ['enclosure' => $csv->getEnclosure(), 'escape' => $csv->getEscape(), 'mode' => $csv->getStreamFilterMode()];
        if ($csv instanceof \League\Csv\Writer && '' != $whitespace_replace) {
     ...
     */
    public static function addFormatterTo(\League\Csv\Writer $csv, string $whitespace_replace) : \League\Csv\Writer
    {
