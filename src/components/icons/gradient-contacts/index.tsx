...
const GradientContactsIcon: React.FC<IconProps> = ({
	width = 24,
	height = 24,
}) => {
	return (
		...
		>
			<path
				...
				fill="url(#paint0_linear_32496_199466)"
			/>
			<path
				...
				fill="url(#paint1_linear_32496_199466)"
			/>
			<path
				opacity="0.4"
				...
				fill="url(#paint2_linear_32496_199466)"
			/>
			<path
				...
				fill="url(#paint3_linear_32496_199466)"
			/>
			<defs>
				<linearGradient
					id="paint0_linear_32496_199466"
					x1="4.25"
					y1="6.745"
					x2="13.75"
					y2="6.745"
...
export default GradientContactsIcon;
