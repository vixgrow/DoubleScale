...
class MasterAccountApi
{
    ...
    {
        $returnType = 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\InlineResponse201';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\InlineResponse201', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\MasterDetailsResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\MasterDetailsResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\SubAccountsResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\SubAccountsResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\SubAccountDetailsResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\SubAccountDetailsResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
            throw $e;
    ...
    {
        $returnType = 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\CreateApiKeyResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\CreateApiKeyResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\CreateSubAccountResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\CreateSubAccountResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\GetSsoToken';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\GetSsoToken', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\GetAccountActivity';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\GetAccountActivity', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\GetCorporateInvitedUsersList';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\GetCorporateInvitedUsersList', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\InlineResponse200[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\InlineResponse200[]', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\InviteAdminUser';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\InviteAdminUser', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\ErrorModel', $e->getResponseHeaders());
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
\class_alias('DoubleScale\\Vendor\\Brevo\\Client\\Api\\MasterAccountApi', 'Brevo\\Client\\Api\\MasterAccountApi', \false);
