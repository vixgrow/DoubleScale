 ...
 *
 * This class is responsible for handling the enrollment tags rule for TutorLMS
 *
 * @since 1.0.0
 *
...
class EnrollmentTags extends Rule {
	 ...
	 * @since 1.0.0
	 */
	public $slug = 'tutorlms_enrollment_tags';
	...
	public function get_value( $automation_contact ) {
		...
		// Get enrolled courses using TutorLMS
		...
		foreach ( $enrolled_courses as $course_id ) {
			$course_tags = get_the_terms( $course_id, 'course-tag' );
