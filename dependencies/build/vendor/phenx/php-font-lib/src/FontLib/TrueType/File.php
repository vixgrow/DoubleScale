...
use DoubleScale\Vendor\FontLib\AdobeFontMetrics;
use DoubleScale\Vendor\FontLib\Font;
use DoubleScale\Vendor\FontLib\BinaryStream;
use DoubleScale\Vendor\FontLib\Table\Table;
use DoubleScale\Vendor\FontLib\Table\DirectoryEntry;
use DoubleScale\Vendor\FontLib\Table\Type\glyf;
use DoubleScale\Vendor\FontLib\Table\Type\name;
use DoubleScale\Vendor\FontLib\Table\Type\nameRecord;
/**
 * TrueType font file.
 *
...
class File extends BinaryStream
{
    ...
    function parseTableEntries()
    {
        ...
        $class = "DoubleScale\\Vendor\\FontLib\\{$type}\\TableDirectoryEntry";
    ...
    protected function readTable($tag)
    {
        ...
        if (!self::$raw) {
            ...
            $class = "DoubleScale\\Vendor\\FontLib\\Table\\Type\\{$name_canon}";
            if (!isset($this->directory[$tag]) || !@\class_exists($class)) {
                return;
            }
        } else {
            $class = "DoubleScale\\Vendor\\FontLib\\Table\\Table";
        }
        /** @var Table $table */
