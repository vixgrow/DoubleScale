        ...
        },
        {
            ...
            render: () => (
                <div className="dropdown table-action">
                    ...
                    <div className="dropdown-menu dropdown-menu-right" data-bs-toggle="modal" data-bs-target="#user-profile-new"
                        style={{ position: 'absolute', inset: '0px auto auto 0px', margin: '0px', transform: 'translate3d(-99.3333px, 35.3333px, 0px)' }} data-popper-placement="bottom-start">
                            ...
                            <div className="content">
                                <div className="text-center right-sidebar-profile mb-3">
                                    <figure className="avatar">
                                        <ImageWithBasePath src="assets/img/users/user-23.jpg" alt="img" />
                                    </figure>
