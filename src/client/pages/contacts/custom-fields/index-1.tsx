 ...
 */
import { Typography, Modal, Popconfirm, Flex, Skeleton } from 'antd';
...
import { CustomDialogHeader, Field, GradientGroupIcon } from '@quillcrm/components';
import {
	Dialog,
	DialogContent,
	DialogHeader,
...
function Droppable({ children, id, title, onDelete, fieldsCount, deletable }) {
	...
	return (
		...
		>
			<div
				className="custom-fields-group-header flex justify-between items-center"
			>
				<Typography.Title
			...
			<div className="custom-fields-group-items flex flex-col gap-5">
				{children}
			</div>
		</div>
	);
...
const CustomFields = forwardRef<CustomFieldsRef, CustomFieldsProps>(
	(props, ref) => {
		...
		return (
			<div className="custom-fields">
				...
				<div className='flex flex-col gap-[10px]' gap={10}>
					<DndContext
						sensors={sensors}
				...
				<Dialog
					...
					onOpenChange={setAddGroupVisible}
				>
