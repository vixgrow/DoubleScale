...
class GetWebhook implements ModelInterface, ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['url' => 'string', 'id' => 'int', 'description' => 'string', 'events' => 'string[]', 'type' => 'string', 'createdAt' => 'string', 'modifiedAt' => 'string', 'batched' => 'bool', 'auth' => 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\GetWebhookAuth', 'headers' => 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\GetWebhookHeaders[]'];
    /**
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
\class_alias('DoubleScale\\Vendor\\Brevo\\Client\\Model\\GetWebhook', 'Brevo\\Client\\Model\\GetWebhook', \false);
