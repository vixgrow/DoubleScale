            ...
            <div className="w-40 flex flex-col justify-center items-center border-r border-gray-200 pr-4">
              {PREDEFINED_DATE_RANGE_OPTIONS.map((range) => (
                <button
                  ...
                  className=" text-center py-1 px-[10px] block  font-normal leading-[26px] text-base text-[#09090B] hover:bg-gray-100 rounded mb-1"
                >
                  {range.label}
                </button>
              ))}
              <button
                ...
                className=" bg-[#458DC7] text-center  font-normal leading-[22px] text-sm text-[#FFF] py-1 px-[10px]  rounded-[6px] mt-2"
              >
