...
namespace QuillCRM\Automations\Rules\LearnDash;
 ...
 */
class Course_Completed extends Rule {
	...
	public function get_operators() {
		return array(
			...
			'not_includes' => __( 'not includes', 'quillcrm' ),
		);
	}
...
add_action(
	...
	function () {
		if ( class_exists( 'SFWD_LMS' ) ) {
			Rules_Manager::instance()->register( new Course_Completed() );
		} else {
			add_action(
				'learndash_loaded',
				function () {
