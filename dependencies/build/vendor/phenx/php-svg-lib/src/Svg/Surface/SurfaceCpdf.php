 ...
 */
namespace DoubleScale\Vendor\Svg\Surface;

use DoubleScale\Vendor\Svg\Document;
use DoubleScale\Vendor\Svg\Style;
class SurfaceCpdf implements SurfaceInterface
{
    ...
    public function __construct(Document $doc, $canvas = null)
    {
        ...
        $h = $dimensions["height"];
        if (!$canvas) {
            $canvas = new \DoubleScale\Vendor\Svg\Surface\CPdf(array(0, 0, $w, $h));
