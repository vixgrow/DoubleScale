...
const ArrowLeft: React.FC<IconProps> = ({ width = 24, height = 24 }) => {
	return (
		<svg
			width={width}
			height={height}
		...
		>
			<path
				...
				fill="url(#paint0_linear_2774_17355)"
			/>
			<path
				...
				fill="url(#paint1_linear_2774_17355)"
			/>
			<defs>
				<linearGradient
					id="paint0_linear_2774_17355"
					x1="2.75244"
					y1="12.0014"
					x2="10.3174"
					y2="12.0014"
