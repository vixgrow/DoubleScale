...
const DeliveryRateIcon: React.FC<IconProps> = ({ width = 24, height = 24 }) => {
	return (
		<svg
			width={width}
			height={height}
		...
		>
			<g clip-path="url(#clip0_32142_177525)">
				<mask
					id="mask0_32142_177525"
...
export default DeliveryRateIcon;
