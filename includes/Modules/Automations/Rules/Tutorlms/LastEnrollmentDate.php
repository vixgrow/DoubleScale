 ...
 *
 * This class is responsible for handling the last enrollment date rule for TutorLMS
 *
 * @since 1.0.0
 *
...
class LastEnrollmentDate extends Rule {
	 ...
	 * @since 1.0.0
	 */
	public $slug = 'tutorlms_last_enrollment_date';
	...
	public function get_value( $automation_contact ) {
		...
		// Query tutor_enrolled posts for last enrollment
		// TutorLMS stores enrollments as custom post type 'tutor_enrolled'
		// post_author = user_id, post_parent = course_id, post_date = enrollment date
		// post_status = 'completed' means actively enrolled (not course completed)
		...
		$last_enrollment = $enrollments[0];
		return gmdate( 'Y-m-d', strtotime( $last_enrollment->post_date ) );
	}
