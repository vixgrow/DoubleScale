 ...
 */
class Reader extends \League\Csv\AbstractCsv implements \League\Csv\TabularDataReader, JsonSerializable
{
    ...
    protected function setHeader(int $offset) : array
    {
        ...
        if (\in_array($header, [[], [null]], \true)) {
            throw \League\Csv\SyntaxError::dueToHeaderNotFound($offset);
        }
        if (0 !== $offset) {
            return $header;
        }
    ...
    {
        return \League\Csv\ResultSet::createFromTabularDataReader($this)->fetchColumn($index);
    }
    /**
     * {@inheritdoc}
     */
    ...
    {
        return \League\Csv\ResultSet::createFromTabularDataReader($this)->fetchOne($nth_record);
    }
    /**
     * {@inheritdoc}
     */
    ...
    {
        return \League\Csv\ResultSet::createFromTabularDataReader($this)->fetchPairs($offset_index, $value_index);
    }
    /**
     * {@inheritdoc}
     */
    ...
    public function getRecords(array $header = []) : Iterator
    {
        ...
        if ($this->is_empty_records_included) {
            ...
            return $this->combineHeader(new \League\Csv\MapIterator($records, $normalized_empty_records), $header);
        }
    ...
    protected function computeHeader(array $header)
    {
        ...
        if ($header !== ($filtered_header = array_filter($header, 'is_string'))) {
            throw \League\Csv\SyntaxError::dueToInvalidHeaderColumnNames();
        }
        if ($header !== array_unique($filtered_header)) {
            throw \League\Csv\SyntaxError::dueToDuplicateHeaderColumnNames($header);
        }
        return $header;
    }
    /**
    ...
    protected function combineHeader(Iterator $iterator, array $header) : Iterator
    {
        ...
        return new \League\Csv\MapIterator($iterator, $mapper);
    }
    /**
    ...
    protected function stripBOM(Iterator $iterator, string $bom) : Iterator
    {
        ...
        return new CallbackFilterIterator(new \League\Csv\MapIterator($iterator, $mapper), $filter);
    }
    /**
    ...
    public function setHeaderOffset(?int $offset) : self
    {
        ...
        if (null !== $offset && 0 > $offset) {
            throw \League\Csv\InvalidArgument::dueToInvalidHeaderOffset($offset, __METHOD__);
        }
