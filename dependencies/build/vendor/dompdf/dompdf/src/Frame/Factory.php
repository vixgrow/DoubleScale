 ...
 */
namespace DoubleScale\Vendor\Dompdf\Frame;
...
use DoubleScale\Vendor\Dompdf\FrameDecorator\Page as PageFrameDecorator;
use DoubleScale\Vendor\Dompdf\FrameReflower\Page as PageFrameReflower;
use DoubleScale\Vendor\Dompdf\Positioner\AbstractPositioner;
use DOMXPath;
/**
...
class Factory
{
    ...
    public static function decorate_frame(Frame $frame, Dompdf $dompdf, ?Frame $root = null) : ?AbstractFrameDecorator
    {
        ...
        $decorator = "DoubleScale\\Vendor\\Dompdf\\FrameDecorator\\{$decorator}";
        $reflower = "DoubleScale\\Vendor\\Dompdf\\FrameReflower\\{$reflower}";
    ...
    protected static function getPositionerInstance(string $type) : AbstractPositioner
    {
        if (!isset(self::$_positioners[$type])) {
            $class = '\\DoubleScale\\Vendor\\Dompdf\\Positioner\\' . $type;
