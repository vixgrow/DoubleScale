...
import { Alert, AlertDescription } from "@quillcrm/components/ui/alert";
import { Button } from "@quillcrm/components/ui/button";
import { Dialog, DialogContent, DialogHeader, DialogOverlay } from "@quillcrm/components/ui/dialog";
            ...
            <DialogContent className="w-full max-w-xl max-h-[80vh] flex flex-col justify-center items-center gap-3 overflow-y-auto my-4 sm:mx-auto z-[1800000] p-8 rounded-[16px]">
                ...
                <DialogHeader className="flex flex-col items-center justify-center w-full gap-4 text-center">
                    ...
                    >
                        ...
                        <AlertDescription className="text-sm">
                            {__('This email will be permanently removed from the sequence.', 'quillcrm')}
                        </AlertDescription>
                    </Alert>
                </DialogHeader>
                ...
                <div className="flex flex-col sm:flex-row gap-3 mt-6 w-full">
                    ...
                    >
                        {loading ? __('Deleting...', 'quillcrm') : __('Yes, Delete', 'quillcrm')}
                    </Button>
                </div>
            </DialogContent>
        </Dialog>
