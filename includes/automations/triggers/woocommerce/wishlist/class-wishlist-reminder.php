 ...
 */
class Wishlist_Reminder extends Trigger {
	...
	public function __construct() {
		 parent::__construct();
		$this->tasks = new \QuillCRM\Tasks( 'quillcrm_wishlist_reminder' );
	}
	...
	public function get_fields() {
		return array(
			'label'   => array(
				'type'  => 'label',
				'label' => __( 'Schedule this automation to run everyday at: ', 'quillcrm' ),
			),
			'hours'   => array(
				'type'        => 'number',
				...
				'min'         => 0,
				'max'         => 23,
				'description' => __( '24-hour format (0-23)', 'quillcrm' ),
			),
			'minutes' => array(
				'type'        => 'number',
				...
				'min'         => 0,
				'max'         => 59,
				'description' => __( 'Minutes (0-59)', 'quillcrm' ),
			),
		);
	}
