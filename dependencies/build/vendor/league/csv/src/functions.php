...
{
    return \League\Csv\Info::fetchBOMSequence($str) ?? '';
}
/**
 ...
 *
 */
function delimiter_detect(\League\Csv\Reader $csv, array $delimiters, int $limit = 1) : array
{
    return \League\Csv\Info::getDelimiterStats($csv, $delimiters, $limit);
}
