 ...
 * Used by Email_Renderer and Email_Processing for conditional sections.
 *
 * @since 1.0.0
 */
class Condition_Evaluator {
	 ...
	 */
	public function evaluate( array $conditions, Contact_Model $contact ) {
		if ( empty( $conditions ) ) {
			return true;
		}
	 ...
	 */
	public function evaluate_single_condition( array $condition, Contact_Model $contact ) {
	 ...
	 * @return bool
	 */
	public function evaluate_list_condition( Contact_Model $contact, $operator, $value ) {
	 ...
	 * @return bool
	 */
	public function evaluate_tag_condition( Contact_Model $contact, $operator, $value ) {
	 ...
	 * @return bool
	 */
	public function evaluate_is_user_condition( Contact_Model $contact, $operator ) {
	 ...
	 * @return bool
	 */
	public function evaluate_user_role_condition( Contact_Model $contact, $operator, $value ) {
		// Get contact's user relationship (eager load if not loaded)
		if ( ! $contact->relationLoaded( 'user' ) ) {
			$contact->load( 'user' );
		}
	 ...
	 * @return bool
	 */
	public function evaluate_lead_score_points_condition( Contact_Model $contact, $operator, $value ) {
	 ...
	 * @return bool
	 */
	public function evaluate_lead_score_level_condition( Contact_Model $contact, $operator, $value ) {
	 ...
	 * @return bool
	 */
	public function evaluate_via_database( array $condition, Contact_Model $contact ) {
		$query           = Contact_Model::where( 'id', $contact->id );
