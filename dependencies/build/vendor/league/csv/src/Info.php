...
final class Info implements \League\Csv\ByteSequence
{
     ...
     */
    public static function getDelimiterStats(\League\Csv\Reader $csv, array $delimiters, int $limit = 1) : array
    {
        ...
        $stmt = \League\Csv\Statement::create()->offset(0)->limit($limit);
