...
/**
 * ElasticemailBulkMailer class
 *
 * @since 1.0.0
 */
class ElasticemailBulkMailer extends AbstractBulkMailer {
	...
	/**
	 * Convert Plugin merge tags to ElasticEmail merge field format
	 *
	...
	public function send_batch( $batch_data ) {
		...
		// Get ElasticEmail Account Api (use from_email for smart routing)
