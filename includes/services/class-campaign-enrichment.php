 ...
 */
class Campaign_Enrichment {

	/**
	 * Class Instance.
	 *
	 * @var Campaign_Enrichment
	 */
	 ...
	 *
	 * @param Campaign_Model $campaign Campaign model instance
	 *
	 * @return Campaign_Model Returns same instance with enriched data
	 */
	public function enrich( Campaign_Model $campaign ) {
	 ...
	 */
	public function compute_all_stats( Campaign_Model $campaign ) {
		$stats = array();
	 ...
	 */
	public function compute_contacts_count( Campaign_Model $campaign ) {
	 ...
	 */
	public function compute_template_counts( Campaign_Model $campaign ) {
	 ...
	 */
	private function normalize_analytics_stats( Campaign_Model $campaign, $analytics_stats ) {
		$stats = array();
	 ...
	 *
	 * @param array $campaigns Array of Campaign_Model instances
	 *
