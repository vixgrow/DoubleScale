...
class MasterDetailsResponsePlanInfo implements ModelInterface, ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['currencyCode' => 'string', 'nextBillingAt' => 'int', 'price' => 'float', 'planPeriod' => 'string', 'subAccounts' => 'int', 'features' => 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\MasterDetailsResponsePlanInfoFeatures[]'];
    /**
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
\class_alias('DoubleScale\\Vendor\\Brevo\\Client\\Model\\MasterDetailsResponsePlanInfo', 'Brevo\\Client\\Model\\MasterDetailsResponsePlanInfo', \false);
