/**
 * Pro-owned SMTP settings tab. The free plugin still ships a default SMTP tab
 * for free-only installs; when Pro loads, `doublescale_settings_smtp_settings`
 * must resolve here so edits and Pro-specific wiring live in this repo.
 *
