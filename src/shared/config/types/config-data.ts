...
export type UserCapabilities = {
	...
	/** WordPress administrators only — toggle the endpoint, manage every key. */
	doublescale_manage_mcp?: boolean;
	/** Any DoubleScale role — issue and revoke their OWN MCP key. */
	doublescale_manage_own_mcp_key?: boolean;
