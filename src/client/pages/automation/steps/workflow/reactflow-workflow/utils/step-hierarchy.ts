 ...
 */
import type { AutomationStep, OrganizedStep, Automation } from '@quillcrm/client';
...
const processStepHierarchy = (
    ...
    getNodePositionLocal: (nodeId: string, fallbackX?: number, fallbackY?: number, step?: AutomationStep, stepIndex?: number) => { x: number; y: number },
    startX: number,
    startY: number,
    nodeWidth: number,
