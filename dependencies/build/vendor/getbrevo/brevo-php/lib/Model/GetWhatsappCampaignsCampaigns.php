...
class GetWhatsappCampaignsCampaigns implements ModelInterface, ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['id' => 'int', 'campaignName' => 'string', 'templateId' => 'string', 'campaignStatus' => 'string', 'scheduledAt' => 'string', 'errorReason' => 'string', 'invalidatedContacts' => 'int', 'readPercentage' => 'float', 'stats' => 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\WhatsappCampStats', 'createdAt' => 'string', 'modifiedAt' => 'string'];
    /**
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
\class_alias('DoubleScale\\Vendor\\Brevo\\Client\\Model\\GetWhatsappCampaignsCampaigns', 'Brevo\\Client\\Model\\GetWhatsappCampaignsCampaigns', \false);
