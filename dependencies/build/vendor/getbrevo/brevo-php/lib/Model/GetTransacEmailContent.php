...
class GetTransacEmailContent implements ModelInterface, ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['email' => 'string', 'subject' => 'string', 'templateId' => 'int', 'date' => 'string', 'events' => 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\GetTransacEmailContentEvents[]', 'body' => 'string', 'attachmentCount' => 'int'];
    /**
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
\class_alias('DoubleScale\\Vendor\\Brevo\\Client\\Model\\GetTransacEmailContent', 'Brevo\\Client\\Model\\GetTransacEmailContent', \false);
