...
use DoubleScale\Vendor\PHPUnit\Framework\Assert as PHPUnit;
...
use DoubleScale\Vendor\Symfony\Component\HttpFoundation\StreamedResponse;
...
class FilesystemAdapter implements FilesystemContract, CloudFilesystemContract
{
    ...
    {
        return $adapter->getContainer()->getObject($path)->getTemporaryUrl(Carbon::now()->diffInSeconds($expiration), $options['method'] ?? 'GET', $options['forcePublicUrl'] ?? \true);
    }
    /**
