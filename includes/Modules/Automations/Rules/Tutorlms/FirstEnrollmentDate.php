 ...
 *
 * This class is responsible for handling the first enrollment date rule for TutorLMS
 *
 * @since 1.0.0
 *
...
class FirstEnrollmentDate extends Rule {
	 ...
	 * @since 1.0.0
	 */
	public $slug = 'tutorlms_first_enrollment_date';
	...
	public function get_value( $automation_contact ) {
		...
		// Query tutor_enrolled posts for first enrollment
		...
		return gmdate( 'Y-m-d', strtotime( $first_enrollment->post_date ) );
	}
