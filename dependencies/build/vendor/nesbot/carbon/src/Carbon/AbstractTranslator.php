...
use DoubleScale\Vendor\Symfony\Component\Translation;
use DoubleScale\Vendor\Symfony\Component\Translation\Formatter\MessageFormatterInterface;
use DoubleScale\Vendor\Symfony\Component\Translation\Loader\ArrayLoader;
abstract class AbstractTranslator extends Translation\Translator
{
    ...
    {
        $locale = $locale ?: 'en';
        $key = static::class === \Carbon\Translator::class ? $locale : static::class . '|' . $locale;
    ...
    protected function translate(?string $id, array $parameters = [], ?string $domain = null, ?string $locale = null) : string
    {
        ...
        $format = $this instanceof \Carbon\TranslatorStrongTypeInterface ? $this->getFromCatalogue($catalogue, (string) $id, $domain) : $this->getCatalogue($locale)->get((string) $id, $domain);
        // @codeCoverageIgnore
