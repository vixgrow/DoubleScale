...
use DoubleScale\Vendor\SendGrid\Mail\To;
use DoubleScale\Vendor\SendGrid\Mail\Cc;
use DoubleScale\Vendor\SendGrid\Mail\Bcc;
use DoubleScale\Vendor\SendGrid\Mail\From;
use DoubleScale\Vendor\SendGrid\Mail\Content;
use DoubleScale\Vendor\SendGrid\Mail\Mail;
use DoubleScale\Vendor\SendGrid\Mail\Personalization;
use DoubleScale\Vendor\SendGrid\Mail\Subject;
use DoubleScale\Vendor\SendGrid\Mail\Header;
use DoubleScale\Vendor\SendGrid\Mail\CustomArg;
use DoubleScale\Vendor\SendGrid\Mail\SendAt;
use DoubleScale\Vendor\SendGrid\Mail\Attachment;
use DoubleScale\Vendor\SendGrid\Mail\Asm;
use DoubleScale\Vendor\SendGrid\Mail\MailSettings;
use DoubleScale\Vendor\SendGrid\Mail\BccSettings;
use DoubleScale\Vendor\SendGrid\Mail\SandBoxMode;
use DoubleScale\Vendor\SendGrid\Mail\BypassBounceManagement;
use DoubleScale\Vendor\SendGrid\Mail\BypassListManagement;
use DoubleScale\Vendor\SendGrid\Mail\BypassSpamManagement;
use DoubleScale\Vendor\SendGrid\Mail\BypassUnsubscribeManagement;
use DoubleScale\Vendor\SendGrid\Mail\Footer;
use DoubleScale\Vendor\SendGrid\Mail\SpamCheck;
use DoubleScale\Vendor\SendGrid\Mail\TrackingSettings;
use DoubleScale\Vendor\SendGrid\Mail\ClickTracking;
use DoubleScale\Vendor\SendGrid\Mail\OpenTracking;
use DoubleScale\Vendor\SendGrid\Mail\SubscriptionTracking;
use DoubleScale\Vendor\SendGrid\Mail\Ganalytics;
use DoubleScale\Vendor\SendGrid\Mail\ReplyTo;
function helloEmail()
{
    try {
...
function sendHelloEmail()
{
    ...
    $sg = new \DoubleScale\Vendor\SendGrid($apiKey);
