...
class SendersApi
{
    ...
    {
        $returnType = 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\CreateSenderModel';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\CreateSenderModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\GetIps';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\GetIps', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
            throw $e;
    ...
    {
        $returnType = 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\GetIpsFromSender';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\GetIpsFromSender', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 404:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\GetSendersList';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\GetSendersList', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\ErrorModel', $e->getResponseHeaders());
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
\class_alias('DoubleScale\\Vendor\\Brevo\\Client\\Api\\SendersApi', 'Brevo\\Client\\Api\\SendersApi', \false);
