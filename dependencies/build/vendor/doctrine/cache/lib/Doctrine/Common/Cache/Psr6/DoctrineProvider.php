...
use DoubleScale\Vendor\Symfony\Component\Cache\Adapter\DoctrineAdapter as SymfonyDoctrineAdapter;
use DoubleScale\Vendor\Symfony\Contracts\Service\ResetInterface;
...
final class DoctrineProvider extends CacheProvider
{
    ...
    {
        if ($pool instanceof \Doctrine\Common\Cache\Psr6\CacheAdapter) {
