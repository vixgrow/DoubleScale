...
const GradientColumnsIcon: React.FC<IconProps> = ({
	width = 24,
	height = 24,
}) => {
	return (
		...
		>
			<path
				...
				fill="url(#paint0_linear_3624_11732)"
			/>
			<path
				...
				fill="url(#paint1_linear_3624_11732)"
			/>
			<defs>
				<linearGradient
					id="paint0_linear_3624_11732"
					x1="13.5"
					y1="12"
					x2="22"
					y2="12"
...
export default GradientColumnsIcon;
