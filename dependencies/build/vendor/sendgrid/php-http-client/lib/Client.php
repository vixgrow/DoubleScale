 ...
 * HTTP Client library
 */
namespace DoubleScale\Vendor\SendGrid;

use DoubleScale\Vendor\SendGrid\Exception\InvalidRequest;
/**
 * Class Client
 * @version 3.9.5
 *
 ...
 * Missed any? Simply add them by doing: @method Client method()
 */
\class_alias('DoubleScale\\Vendor\\SendGrid\\Client', 'SendGrid\\Client', \false);
