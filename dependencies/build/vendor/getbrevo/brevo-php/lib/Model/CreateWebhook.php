...
class CreateWebhook implements ModelInterface, ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['url' => 'string', 'description' => 'string', 'events' => 'string[]', 'type' => 'string', 'domain' => 'string', 'batched' => 'bool', 'auth' => 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\GetWebhookAuth', 'headers' => 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\GetWebhookHeaders[]'];
    /**
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
\class_alias('DoubleScale\\Vendor\\Brevo\\Client\\Model\\CreateWebhook', 'Brevo\\Client\\Model\\CreateWebhook', \false);
