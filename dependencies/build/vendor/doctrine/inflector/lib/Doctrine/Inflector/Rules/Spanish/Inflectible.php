...
class Inflectible
{
    ...
    {
        (yield new Transformation(new Pattern('/ú([sn])$/i'), 'DoubleScale\\Vendor\\u\\1es'));
        (yield new Transformation(new Pattern('/ó([sn])$/i'), 'DoubleScale\\Vendor\\o\\1es'));
        (yield new Transformation(new Pattern('/í([sn])$/i'), 'DoubleScale\\Vendor\\i\\1es'));
        (yield new Transformation(new Pattern('/é([sn])$/i'), 'DoubleScale\\Vendor\\e\\1es'));
        (yield new Transformation(new Pattern('/á([sn])$/i'), 'DoubleScale\\Vendor\\a\\1es'));
