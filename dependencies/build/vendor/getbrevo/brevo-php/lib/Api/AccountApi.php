...
class AccountApi
{
    ...
    {
        $returnType = 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\GetAccount';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\GetAccount', $e->getResponseHeaders());
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
\class_alias('DoubleScale\\Vendor\\Brevo\\Client\\Api\\AccountApi', 'Brevo\\Client\\Api\\AccountApi', \false);
