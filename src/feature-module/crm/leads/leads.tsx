      ...
      render: () => (
        <div className="dropdown table-action">
          ...
          <div className="dropdown-menu dropdown-menu-right">
            <Link className="dropdown-item" to="#" onClick={() => togglePopup(true)} >
              <i className="ti ti-edit text-blue" /> Edit
            </Link>
           
            <Link className="dropdown-item" to="#" data-bs-toggle="modal" data-bs-target="#delete_contact"><i className="ti ti-trash text-danger"></i> Delete</Link>
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-12">
                      <div className="form-wrap">
                        ...
                        <Select className="select" options={options} styles={customStyles}/>
                      </div>
                    </div>
                    <div className="col-md-6">
                      <div className="form-wrap">
                    ...
                    <div className="col-md-6">
                      <div className="form-wrap">
                        ...
                        <Select className="select" options={optionssymbol} styles={customStyles}/>
                      </div>
                    </div>
                    <div className="col-md-12">
                      <div className="row">
                    ...
                    <div className="col-md-6">
                      <div className="form-wrap">
                        ...
                        <Select className="select" options={optionsource} styles={customStyles}/>
                      </div>
                    </div>
                    <div className="col-md-6">
                      <div className="form-wrap">
                        ...
                        <Select className="select" options={optionindustry} styles={customStyles}/>
                      </div>
                    </div>
                    <div className="col-md-6">
                      <div className="form-wrap">
