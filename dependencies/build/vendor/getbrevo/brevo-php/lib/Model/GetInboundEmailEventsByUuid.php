...
class GetInboundEmailEventsByUuid implements ModelInterface, ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['receivedAt' => '\\DateTime', 'deliveredAt' => '\\DateTime', 'recipient' => 'string', 'sender' => 'string', 'messageId' => 'string', 'subject' => 'string', 'attachments' => 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\GetInboundEmailEventsByUuidAttachments[]', 'logs' => 'DoubleScale\\Vendor\\Brevo\\Client\\Model\\GetInboundEmailEventsByUuidLogs[]'];
    /**
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
\class_alias('DoubleScale\\Vendor\\Brevo\\Client\\Model\\GetInboundEmailEventsByUuid', 'Brevo\\Client\\Model\\GetInboundEmailEventsByUuid', \false);
